...
- Spending decomposition splits expected per-entrant cost by recipient group (≤19 vs 20+ YOS): under H3 100% of spending goes to the 20+ minority by construction; under BRS only ~1–4% reaches the <20 majority — savings come from the smaller pension BRS pays each career retiree (12–14% less), which outweighs the cost of the new TSP contributions BRS pays to all members. Also prices the cliff in govt dollars (the 20th year adds ~$0.8–1.7M to the obligation). Caveat in-notebook: actuarial cost ≈ half the member-side value of the early-separatee TSP benefit.
